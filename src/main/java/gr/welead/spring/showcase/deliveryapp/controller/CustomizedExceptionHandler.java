...
import gr.welead.spring.showcase.deliveryapp.transfer.ApiError;
...
public class CustomizedExceptionHandler extends BaseComponent {
    ...
    public ResponseEntity<ApiResponse<?>> handleExceptions(final Exception ex, final WebRequest request){
